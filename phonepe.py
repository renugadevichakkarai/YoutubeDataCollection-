...
st.set_page_config(
    page_title="My Unique Streamlit Page",
    page_icon="🚀",
    layout="wide",
...
# Define a CSS style to apply color to the title
title_style = """
    <style>
        .title-text {
            color: #ff5733; /* Specify the desired color using a hex code or other CSS color format */
        }
    </style>
"""

# Apply the style to the title using the `st.markdown` function
st.markdown(title_style, unsafe_allow_html=True)
st.markdown("<h1 class='title-text'>PHONEPE DATA VISUALIZATION AND EXPLORATION</h1>", unsafe_allow_html=True)
...
with tab1:
    ...
    with col2:
         st.image("	https://1000logos.net/wp-content/uploads/2022/11/PhonePe-Emblem.png",caption="Phonepe",use_column_width=True)
